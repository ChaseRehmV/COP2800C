public class ArrPlayground {
    public static void main(String[] args) {
        // creating objects that help display and calculate elements of an array
        ArrElementDisplay arrayPrinter = new ArrElementDisplay();
        ArrElementCalc arrayCalc = new ArrElementCalc();
        ...
        arrayPrinter.printElements(names);
        ...
        System.out.println(arrayCalc.calcAvg(intArrOne));
        System.out.println(arrayCalc.calcAvg(intArrTwo));
        ...
        System.out.println(arrayCalc.calcAvg(doubleArrOne));
        System.out.println(arrayCalc.calcAvg(doubleArrTwo));
    }
}
